...
async function sendMessage(channel, textMessage, blocks) {
  await slack.chat.postMessage({channel : channel, text: textMessage, blocks: blocks})
}
...
async function test() {
  await sendMessage("develop-subscriptions", "test", [
